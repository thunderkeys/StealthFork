...
Some parts are not included in this repo and need to be pulled directly from the **Micron R1 Repo** to convert your current Salad Fork. This is intended to prevent having to update several files that can be used for both printers. However, this may change and they all get uploaded here if it becomes too much of a pain based on feedback. 
...
| **Front Idler Carrier** | [Idler Carrier](https://github.com/PrintersForAnts/Micron/tree/main/STLs/Gantry/Idlers) | Screwed or Pinned available |
...
| Date         | Changes                                                    |
|--------------|------------------------------------------------------------|
| 28-Oct-2025  | `[a]_Z_Bed_Mount_Front_L_x1.stl` & `[a]_Z_Bed_Mount_Front_R_x1.stl` updated to remove interferance with extrusion. |
...
- **Thunderkeys** for his help with various STL issues
